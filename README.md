...
- Validate basic MeTTa-like syntax, required metadata, unary ID-declaration and binary metadata/retrieval relation arity, symbol IDs, local `Contains` boundaries, and size limits.
